...
import sys
import pygame
from code.const import COLOR_BLUESKY, COLOR_FLAME, COLOR_TURBOBLUE, COLOR_DARKGREEN, COLOR_ORANGEFIRE, ENEMY_SPAWN, EVENT_TIMEOUT, MENU_OPTION, SPAWN_TIME, STAGE_TIMEOUT, STEP_TIMEOUT, WIN_HEIGHT
...
class Level:
    def __init__(self, window: pygame.Surface, name: str, game_mode: str, player_score:list[int]):
        self.timeout = STAGE_TIMEOUT #ms = 95seconds
        self.window = window
        self.name = name
